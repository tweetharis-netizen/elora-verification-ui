...
import llmRoutes from '../server/routes/llm.routes.js';
import copilotFeedbackRoutes from '../server/routes/copilotFeedback.routes.js';
import copilotInsightsRoutes from '../server/routes/copilotInsights.routes.js';
...
app.use('/api/copilot', copilotFeedbackRoutes);
app.use('/api/internal/copilot', copilotInsightsRoutes);
