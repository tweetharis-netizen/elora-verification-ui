    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 bg-white dark:bg-neutral-900 rounded-2xl p-8 border-premium shadow-premium-sm">
                ...
                <div className="lg:col-span-4 bg-white dark:bg-neutral-900 rounded-2xl p-8 border-premium shadow-premium-sm">
            ...
            {/* Student Table */}
            <div className="bg-white dark:bg-neutral-900 rounded-2xl p-8 border-premium shadow-premium-sm overflow-hidden">
                <div className="flex items-center justify-between mb-8">
