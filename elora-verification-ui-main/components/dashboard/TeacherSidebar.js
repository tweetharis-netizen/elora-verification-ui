...
export default function TeacherSidebar({
    ...
    return (
        <div className="w-full lg:w-72 flex-shrink-0 space-y-6">
            <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 border-premium shadow-premium-sm">
            ...
            <div className="bg-primary-600 rounded-2xl p-6 text-white shadow-premium-md relative overflow-hidden group">
