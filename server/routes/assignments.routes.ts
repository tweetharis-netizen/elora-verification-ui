...
import { getAssignments, submitAssignment, createAssignment, getStudentAssignments, getAssignmentResults, submitAssignmentAttempt } from '../controllers/assignments.js';
