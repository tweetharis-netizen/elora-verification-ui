...
router.patch('/copilot/conversations/:id', requireAuth, requireRole('teacher'), updateTeacherCopilotConversationTitle);
router.delete('/copilot/conversations/:id', requireAuth, requireRole('teacher'), deleteTeacherCopilotConversation);
